...
module MainColorLightMuraxSoc (
  ...
  wire       [0:0]    system_ledsctrl_io_leds;
  ...
  assign system_mainBusDecoder_logic_hits_0 = ((system_mainBusDecoder_logic_masterPipelined_cmd_payload_address & (~ 32'h0000ffff)) == 32'h0);
  always @(*) begin
...
module Apb3UartCtrl (
  ...
  function [19:0] zz_bridge_uartConfigReg_clockDivider(input dummy);
    begin
      ...
      zz_bridge_uartConfigReg_clockDivider = 20'h0004d;
    end
  endfunction
  wire [19:0] _zz_1;
...
module PipelinedMemoryBusRam (
  ...
  wire       [13:0]   _zz_ram_port;
  wire       [13:0]   _zz_io_bus_rsp_payload_data_2;
  ...
  assign _zz_io_bus_rsp_payload_data_2 = _zz_io_bus_rsp_payload_data[13:0];
  initial begin
    $readmemb("ColorLightMuraxSoc.v_toplevel_murax_system_ram_ram_symbol0.bin",ram_symbol0);
    $readmemb("ColorLightMuraxSoc.v_toplevel_murax_system_ram_ram_symbol1.bin",ram_symbol1);
    $readmemb("ColorLightMuraxSoc.v_toplevel_murax_system_ram_ram_symbol2.bin",ram_symbol2);
    $readmemb("ColorLightMuraxSoc.v_toplevel_murax_system_ram_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
