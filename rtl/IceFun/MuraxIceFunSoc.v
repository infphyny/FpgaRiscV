...
module PipelinedMemoryBusRam (
  ...
  initial begin
    $readmemb("MuraxIceFunSoc.v_toplevel_murax_system_ram_ram_symbol0.bin",ram_symbol0);
    $readmemb("MuraxIceFunSoc.v_toplevel_murax_system_ram_ram_symbol1.bin",ram_symbol1);
    $readmemb("MuraxIceFunSoc.v_toplevel_murax_system_ram_ram_symbol2.bin",ram_symbol2);
    $readmemb("MuraxIceFunSoc.v_toplevel_murax_system_ram_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
