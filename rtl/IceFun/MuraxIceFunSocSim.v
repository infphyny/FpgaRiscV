...
`define fsm_enumDefinition_binary_sequential_fsm_col0 3'b010
`define fsm_enumDefinition_binary_sequential_fsm_col1 3'b011
`define fsm_enumDefinition_binary_sequential_fsm_col2 3'b100
`define fsm_enumDefinition_binary_sequential_fsm_col3 3'b101


module MuraxIceFunSocSim (
  input               io_mainClk,
  input               io_jtag_tck,
  input               io_jtag_tdi,
  output              io_jtag_tdo,
  ...
  wire                murax_io_uart_txd;
  wire                murax_io_i2c_scl_write;
  wire                murax_io_i2c_sda_write;
  wire                murax_io_spi_sclk;
  wire                murax_io_spi_mosi;
  ...
  IceFunSoc murax (
    ...
    .io_uart_txd             (murax_io_uart_txd           ), //o
    .io_uart_rxd             (io_uart_rxd                 ), //i
    .io_i2c_sda_write        (murax_io_i2c_sda_write      ), //o
    .io_i2c_sda_read         (_zz_io_i2c_sda_read         ), //i
    .io_i2c_scl_write        (murax_io_i2c_scl_write      ), //o
    .io_i2c_scl_read         (_zz_io_i2c_scl_read         ), //i
    .io_spi_ss               (murax_io_spi_ss             ), //o
    .io_spi_sclk             (murax_io_spi_sclk           ), //o
    .io_spi_mosi             (murax_io_spi_mosi           ), //o
  ...
  assign io_gpioA[0] = _zz_io_gpioA_15 ? _zz_io_gpioA_16[0] : 1'bz;
  assign io_gpioA[1] = _zz_io_gpioA_14 ? _zz_io_gpioA_16[1] : 1'bz;
  assign io_gpioA[2] = _zz_io_gpioA_13 ? _zz_io_gpioA_16[2] : 1'bz;
  assign io_gpioA[3] = _zz_io_gpioA_12 ? _zz_io_gpioA_16[3] : 1'bz;
  assign io_gpioA[4] = _zz_io_gpioA_11 ? _zz_io_gpioA_16[4] : 1'bz;
  assign io_gpioA[5] = _zz_io_gpioA_10 ? _zz_io_gpioA_16[5] : 1'bz;
  assign io_gpioA[6] = _zz_io_gpioA_9 ? _zz_io_gpioA_16[6] : 1'bz;
  assign io_gpioA[7] = _zz_io_gpioA_8 ? _zz_io_gpioA_16[7] : 1'bz;
  assign io_gpioA[8] = _zz_io_gpioA_7 ? _zz_io_gpioA_16[8] : 1'bz;
  assign io_gpioA[9] = _zz_io_gpioA_6 ? _zz_io_gpioA_16[9] : 1'bz;
  assign io_gpioA[10] = _zz_io_gpioA_5 ? _zz_io_gpioA_16[10] : 1'bz;
  assign io_gpioA[11] = _zz_io_gpioA_4 ? _zz_io_gpioA_16[11] : 1'bz;
  assign io_gpioA[12] = _zz_io_gpioA_3 ? _zz_io_gpioA_16[12] : 1'bz;
  assign io_gpioA[13] = _zz_io_gpioA_2 ? _zz_io_gpioA_16[13] : 1'bz;
  assign io_gpioA[14] = _zz_io_gpioA_1 ? _zz_io_gpioA_16[14] : 1'bz;
  assign io_gpioA[15] = _zz_io_gpioA ? _zz_io_gpioA_16[15] : 1'bz;
  always @(*) begin
    _zz_io_gpioA = 1'b0;
  ...
  always @(*) begin
    _zz_io_gpioA_10 = 1'b0;
    if(when_InOutWrapper_l65_5) begin
      _zz_io_gpioA_10 = 1'b1;
    end
  end

  always @(*) begin
    _zz_io_gpioA_11 = 1'b0;
    if(when_InOutWrapper_l65_4) begin
      _zz_io_gpioA_11 = 1'b1;
    end
  end

  always @(*) begin
    _zz_io_gpioA_12 = 1'b0;
    if(when_InOutWrapper_l65_3) begin
      _zz_io_gpioA_12 = 1'b1;
    end
  end

  always @(*) begin
    _zz_io_gpioA_13 = 1'b0;
    if(when_InOutWrapper_l65_2) begin
      _zz_io_gpioA_13 = 1'b1;
    end
  end

  always @(*) begin
    _zz_io_gpioA_14 = 1'b0;
    if(when_InOutWrapper_l65_1) begin
      _zz_io_gpioA_14 = 1'b1;
    end
  end

  always @(*) begin
    _zz_io_gpioA_15 = 1'b0;
    if(when_InOutWrapper_l65) begin
      _zz_io_gpioA_15 = 1'b1;
    end
  end
  ...
  assign io_uart_txd = murax_io_uart_txd;
  assign io_leds = murax_io_leds;
  assign io_ledCols = murax_io_ledCols;
  assign _zz_when_InOutWrapper_l48 = murax_io_i2c_sda_write;
  assign _zz_when_InOutWrapper_l48_1 = murax_io_i2c_scl_write;
  assign io_spi_ss = murax_io_spi_ss;
  assign io_spi_sclk = murax_io_spi_sclk;
  assign io_spi_mosi = murax_io_spi_mosi;
  assign _zz_io_i2c_scl_read = io_i2c_scl;
  assign when_InOutWrapper_l48 = (! _zz_when_InOutWrapper_l48_2[0]);
  assign _zz_io_i2c_sda_read = io_i2c_sda;
  assign when_InOutWrapper_l48_1 = (! _zz_when_InOutWrapper_l48_1_1[0]);
  assign _zz_io_gpioA_read = io_gpioA;
...
module IceFunSoc (
  ...
  wire       [7:0]    system_ledctrl_io_apb_PADDR;
  ...
  wire                system_ledctrl_io_apb_PREADY;
  wire       [31:0]   system_ledctrl_io_apb_PRDATA;
  wire                system_ledctrl_io_apb_PSLVERROR;
  wire       [7:0]    system_ledctrl_io_leds;
  wire       [3:0]    system_ledctrl_io_ledCols;
  ...
  MuraxLedCtrl system_ledctrl (
    .io_apb_PADDR             (system_ledctrl_io_apb_PADDR        ), //i
    .io_apb_PSEL              (apb3Router_1_io_outputs_5_PSEL     ), //i
    .io_apb_PENABLE           (apb3Router_1_io_outputs_5_PENABLE  ), //i
    .io_apb_PREADY            (system_ledctrl_io_apb_PREADY       ), //o
    .io_apb_PWRITE            (apb3Router_1_io_outputs_5_PWRITE   ), //i
    .io_apb_PWDATA            (apb3Router_1_io_outputs_5_PWDATA   ), //i
    .io_apb_PRDATA            (system_ledctrl_io_apb_PRDATA       ), //o
    .io_apb_PSLVERROR         (system_ledctrl_io_apb_PSLVERROR    ), //o
    .io_leds                  (system_ledctrl_io_leds             ), //o
    .io_ledCols               (system_ledctrl_io_ledCols          ), //o
    .io_mainClk               (io_mainClk                         ), //i
    .resetCtrl_systemReset    (resetCtrl_systemReset              )  //i
  );
  ...
  Apb3Router apb3Router_1 (
    ...
    .io_outputs_5_PREADY       (system_ledctrl_io_apb_PREADY       ), //i
    .io_outputs_5_PWRITE       (apb3Router_1_io_outputs_5_PWRITE   ), //o
    .io_outputs_5_PWDATA       (apb3Router_1_io_outputs_5_PWDATA   ), //o
    .io_outputs_5_PRDATA       (system_ledctrl_io_apb_PRDATA       ), //i
    .io_outputs_5_PSLVERROR    (system_ledctrl_io_apb_PSLVERROR    ), //i
    .io_mainClk                (io_mainClk                         ), //i
    .resetCtrl_systemReset     (resetCtrl_systemReset              )  //i
  );
  always @(*) begin
  ...
  assign io_leds = system_ledctrl_io_leds;
  assign io_ledCols = system_ledctrl_io_ledCols;
  ...
  assign system_ledctrl_io_apb_PADDR = apb3Router_1_io_outputs_5_PADDR[7:0];
  assign system_mainBusDecoder_logic_masterPipelined_cmd_valid = system_mainBusArbiter_io_masterBus_cmd_valid;
  assign system_mainBusDecoder_logic_masterPipelined_cmd_payload_write = system_mainBusArbiter_io_masterBus_cmd_payload_write;
  assign system_mainBusDecoder_logic_masterPipelined_cmd_payload_address = system_mainBusArbiter_io_masterBus_cmd_payload_address;
  assign system_mainBusDecoder_logic_masterPipelined_cmd_payload_data = system_mainBusArbiter_io_masterBus_cmd_payload_data;
  assign system_mainBusDecoder_logic_masterPipelined_cmd_payload_mask = system_mainBusArbiter_io_masterBus_cmd_payload_mask;
  assign system_mainBusDecoder_logic_hits_0 = ((system_mainBusDecoder_logic_masterPipelined_cmd_payload_address & (~ 32'h00001fff)) == 32'h0);
  always @(*) begin
...
module MuraxLedCtrl (
  ...
  wire       [7:0]    ledCtrl_io_leds;
  wire       [3:0]    ledCtrl_io_ledCols;
  wire                busCtrl_askWrite;
  wire                busCtrl_askRead;
  wire                busCtrl_doWrite;
  wire                busCtrl_doRead;
  reg        [31:0]   ledctrl_bridge_data_in_register;
  reg        [15:0]   ledctrl_bridge_divider_register;

  IceFunLedCtrl ledCtrl (
    .io_data_in               (ledctrl_bridge_data_in_register  ), //i
    .io_divider               (ledctrl_bridge_divider_register  ), //i
    .io_leds                  (ledCtrl_io_leds                  ), //o
    .io_ledCols               (ledCtrl_io_ledCols               ), //o
    .io_mainClk               (io_mainClk                       ), //i
    .resetCtrl_systemReset    (resetCtrl_systemReset            )  //i
  );
  ...
  always @(*) begin
    ...
    case(io_apb_PADDR)
      8'h0 : begin
        io_apb_PRDATA[31 : 0] = ledctrl_bridge_data_in_register;
      end
      8'h04 : begin
        io_apb_PRDATA[15 : 0] = ledctrl_bridge_divider_register;
      end
      default : begin
      end
    endcase
  ...
  assign io_leds = ledCtrl_io_leds;
  assign io_ledCols = ledCtrl_io_ledCols;
  always @(posedge io_mainClk or posedge resetCtrl_systemReset) begin
    if(resetCtrl_systemReset) begin
      ledctrl_bridge_data_in_register <= 32'h0;
      ledctrl_bridge_divider_register <= 16'h0;
    end else begin
      case(io_apb_PADDR)
        8'h0 : begin
          if(busCtrl_doWrite) begin
            ledctrl_bridge_data_in_register <= io_apb_PWDATA[31 : 0];
          end
        end
        8'h04 : begin
          if(busCtrl_doWrite) begin
            ledctrl_bridge_divider_register <= io_apb_PWDATA[15 : 0];
          end
        end
        default : begin
        end
...
module Apb3UartCtrl (
  ...
  function [19:0] zz_bridge_uartConfigReg_clockDivider(input dummy);
    begin
      ...
      zz_bridge_uartConfigReg_clockDivider = 20'h00052;
    end
  endfunction
  wire [19:0] _zz_1;
...
module PipelinedMemoryBusRam (
  ...
  initial begin
    $readmemb("MuraxIceFunSocSim.v_toplevel_murax_system_ram_ram_symbol0.bin",ram_symbol0);
    $readmemb("MuraxIceFunSocSim.v_toplevel_murax_system_ram_ram_symbol1.bin",ram_symbol1);
    $readmemb("MuraxIceFunSocSim.v_toplevel_murax_system_ram_ram_symbol2.bin",ram_symbol2);
    $readmemb("MuraxIceFunSocSim.v_toplevel_murax_system_ram_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
...
module VexRiscv (
  ...
  wire       [19:0]   _zz__zz_decode_BRANCH_CTRL_2_13;
  ...
  wire       [15:0]   _zz__zz_decode_BRANCH_CTRL_2_25;
  ...
  wire       [11:0]   _zz__zz_decode_BRANCH_CTRL_2_35;
  ...
  wire       [7:0]    _zz__zz_decode_BRANCH_CTRL_2_53;
  wire       [5:0]    _zz__zz_decode_BRANCH_CTRL_2_54;
  ...
  wire       [5:0]    _zz__zz_decode_BRANCH_CTRL_2_69;
  ...
  wire       [4:0]    _zz__zz_decode_BRANCH_CTRL_2_78;
  ...
  wire       [3:0]    _zz__zz_decode_BRANCH_CTRL_2_87;
  ...
  wire       `BranchCtrlEnum_binary_sequential_type _zz_decode_BRANCH_CTRL_7;
  ...
  assign _zz__zz_decode_BRANCH_CTRL_2_3 = ((decode_INSTRUCTION & 32'h00007054) == 32'h00005010);
  assign _zz__zz_decode_BRANCH_CTRL_2_4 = 1'b0;
  assign _zz__zz_decode_BRANCH_CTRL_2_5 = ({(_zz__zz_decode_BRANCH_CTRL_2_6 == _zz__zz_decode_BRANCH_CTRL_2_7),(_zz__zz_decode_BRANCH_CTRL_2_8 == _zz__zz_decode_BRANCH_CTRL_2_9)} != 2'b00);
  assign _zz__zz_decode_BRANCH_CTRL_2_10 = ((_zz__zz_decode_BRANCH_CTRL_2_11 == _zz__zz_decode_BRANCH_CTRL_2_12) != 1'b0);
  assign _zz__zz_decode_BRANCH_CTRL_2_13 = {(_zz__zz_decode_BRANCH_CTRL_2_14 != 1'b0),{(_zz__zz_decode_BRANCH_CTRL_2_15 != _zz__zz_decode_BRANCH_CTRL_2_16),{_zz__zz_decode_BRANCH_CTRL_2_17,{_zz__zz_decode_BRANCH_CTRL_2_22,_zz__zz_decode_BRANCH_CTRL_2_25}}}};
  ...
  assign _zz__zz_decode_BRANCH_CTRL_2_11 = (decode_INSTRUCTION & 32'h00000064);
  assign _zz__zz_decode_BRANCH_CTRL_2_12 = 32'h00000024;
  assign _zz__zz_decode_BRANCH_CTRL_2_14 = ((decode_INSTRUCTION & 32'h00001000) == 32'h00001000);
  assign _zz__zz_decode_BRANCH_CTRL_2_15 = ((decode_INSTRUCTION & 32'h00003000) == 32'h00002000);
  assign _zz__zz_decode_BRANCH_CTRL_2_16 = 1'b0;
  assign _zz__zz_decode_BRANCH_CTRL_2_17 = ({(_zz__zz_decode_BRANCH_CTRL_2_18 == _zz__zz_decode_BRANCH_CTRL_2_19),(_zz__zz_decode_BRANCH_CTRL_2_20 == _zz__zz_decode_BRANCH_CTRL_2_21)} != 2'b00);
  assign _zz__zz_decode_BRANCH_CTRL_2_22 = ((_zz__zz_decode_BRANCH_CTRL_2_23 == _zz__zz_decode_BRANCH_CTRL_2_24) != 1'b0);
  assign _zz__zz_decode_BRANCH_CTRL_2_25 = {(_zz_decode_BRANCH_CTRL_4 != 1'b0),{(_zz__zz_decode_BRANCH_CTRL_2_26 != _zz__zz_decode_BRANCH_CTRL_2_29),{_zz__zz_decode_BRANCH_CTRL_2_30,{_zz__zz_decode_BRANCH_CTRL_2_32,_zz__zz_decode_BRANCH_CTRL_2_35}}}};
  assign _zz__zz_decode_BRANCH_CTRL_2_18 = (decode_INSTRUCTION & 32'h00002010);
  assign _zz__zz_decode_BRANCH_CTRL_2_19 = 32'h00002000;
  assign _zz__zz_decode_BRANCH_CTRL_2_20 = (decode_INSTRUCTION & 32'h00005000);
  assign _zz__zz_decode_BRANCH_CTRL_2_21 = 32'h00001000;
  assign _zz__zz_decode_BRANCH_CTRL_2_23 = (decode_INSTRUCTION & 32'h00004004);
  assign _zz__zz_decode_BRANCH_CTRL_2_24 = 32'h00004000;
  assign _zz__zz_decode_BRANCH_CTRL_2_26 = {((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_27) == 32'h00000040),((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_28) == 32'h00000040)};
  assign _zz__zz_decode_BRANCH_CTRL_2_29 = 2'b00;
  assign _zz__zz_decode_BRANCH_CTRL_2_30 = (((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_31) == 32'h00000050) != 1'b0);
  assign _zz__zz_decode_BRANCH_CTRL_2_32 = ({_zz__zz_decode_BRANCH_CTRL_2_33,_zz__zz_decode_BRANCH_CTRL_2_34} != 2'b00);
  assign _zz__zz_decode_BRANCH_CTRL_2_35 = {({_zz__zz_decode_BRANCH_CTRL_2_36,_zz__zz_decode_BRANCH_CTRL_2_38} != 2'b00),{(_zz__zz_decode_BRANCH_CTRL_2_40 != _zz__zz_decode_BRANCH_CTRL_2_42),{_zz__zz_decode_BRANCH_CTRL_2_43,{_zz__zz_decode_BRANCH_CTRL_2_46,_zz__zz_decode_BRANCH_CTRL_2_53}}}};
  assign _zz__zz_decode_BRANCH_CTRL_2_27 = 32'h00000050;
  assign _zz__zz_decode_BRANCH_CTRL_2_28 = 32'h00103040;
  assign _zz__zz_decode_BRANCH_CTRL_2_31 = 32'h00103050;
  assign _zz__zz_decode_BRANCH_CTRL_2_33 = ((decode_INSTRUCTION & 32'h00001050) == 32'h00001050);
  assign _zz__zz_decode_BRANCH_CTRL_2_34 = ((decode_INSTRUCTION & 32'h00002050) == 32'h00002050);
  assign _zz__zz_decode_BRANCH_CTRL_2_36 = ((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_37) == 32'h00000020);
  assign _zz__zz_decode_BRANCH_CTRL_2_38 = ((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_39) == 32'h00000020);
  assign _zz__zz_decode_BRANCH_CTRL_2_40 = ((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_41) == 32'h00000020);
  assign _zz__zz_decode_BRANCH_CTRL_2_42 = 1'b0;
  assign _zz__zz_decode_BRANCH_CTRL_2_43 = ((_zz__zz_decode_BRANCH_CTRL_2_44 == _zz__zz_decode_BRANCH_CTRL_2_45) != 1'b0);
  assign _zz__zz_decode_BRANCH_CTRL_2_46 = ({_zz__zz_decode_BRANCH_CTRL_2_47,_zz__zz_decode_BRANCH_CTRL_2_48} != 3'b000);
  assign _zz__zz_decode_BRANCH_CTRL_2_53 = {(_zz__zz_decode_BRANCH_CTRL_2_54 != _zz__zz_decode_BRANCH_CTRL_2_69),{_zz__zz_decode_BRANCH_CTRL_2_70,{_zz__zz_decode_BRANCH_CTRL_2_73,_zz__zz_decode_BRANCH_CTRL_2_78}}};
  assign _zz__zz_decode_BRANCH_CTRL_2_37 = 32'h00000034;
  assign _zz__zz_decode_BRANCH_CTRL_2_39 = 32'h00000064;
  assign _zz__zz_decode_BRANCH_CTRL_2_41 = 32'h00000020;
  assign _zz__zz_decode_BRANCH_CTRL_2_44 = (decode_INSTRUCTION & 32'h00000010);
  assign _zz__zz_decode_BRANCH_CTRL_2_45 = 32'h00000010;
  assign _zz__zz_decode_BRANCH_CTRL_2_47 = _zz_decode_BRANCH_CTRL_5;
  assign _zz__zz_decode_BRANCH_CTRL_2_48 = {(_zz__zz_decode_BRANCH_CTRL_2_49 == _zz__zz_decode_BRANCH_CTRL_2_50),(_zz__zz_decode_BRANCH_CTRL_2_51 == _zz__zz_decode_BRANCH_CTRL_2_52)};
  assign _zz__zz_decode_BRANCH_CTRL_2_54 = {_zz_decode_BRANCH_CTRL_6,{_zz__zz_decode_BRANCH_CTRL_2_55,{_zz__zz_decode_BRANCH_CTRL_2_57,_zz__zz_decode_BRANCH_CTRL_2_60}}};
  assign _zz__zz_decode_BRANCH_CTRL_2_69 = 6'h0;
  assign _zz__zz_decode_BRANCH_CTRL_2_70 = ({_zz_decode_BRANCH_CTRL_5,_zz__zz_decode_BRANCH_CTRL_2_71} != 2'b00);
  assign _zz__zz_decode_BRANCH_CTRL_2_73 = ({_zz__zz_decode_BRANCH_CTRL_2_74,_zz__zz_decode_BRANCH_CTRL_2_75} != 2'b00);
  assign _zz__zz_decode_BRANCH_CTRL_2_78 = {(_zz__zz_decode_BRANCH_CTRL_2_79 != _zz__zz_decode_BRANCH_CTRL_2_87),{_zz__zz_decode_BRANCH_CTRL_2_88,{_zz__zz_decode_BRANCH_CTRL_2_91,_zz__zz_decode_BRANCH_CTRL_2_97}}};
  assign _zz__zz_decode_BRANCH_CTRL_2_49 = (decode_INSTRUCTION & 32'h00002050);
  assign _zz__zz_decode_BRANCH_CTRL_2_50 = 32'h00002010;
  assign _zz__zz_decode_BRANCH_CTRL_2_51 = (decode_INSTRUCTION & 32'h00001050);
  assign _zz__zz_decode_BRANCH_CTRL_2_52 = 32'h00000010;
  assign _zz__zz_decode_BRANCH_CTRL_2_55 = ((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_56) == 32'h00001010);
  assign _zz__zz_decode_BRANCH_CTRL_2_57 = (_zz__zz_decode_BRANCH_CTRL_2_58 == _zz__zz_decode_BRANCH_CTRL_2_59);
  assign _zz__zz_decode_BRANCH_CTRL_2_60 = {_zz__zz_decode_BRANCH_CTRL_2_61,{_zz__zz_decode_BRANCH_CTRL_2_63,_zz__zz_decode_BRANCH_CTRL_2_66}};
  assign _zz__zz_decode_BRANCH_CTRL_2_71 = ((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_72) == 32'h00000020);
  assign _zz__zz_decode_BRANCH_CTRL_2_74 = _zz_decode_BRANCH_CTRL_5;
  ...
  assign _zz__zz_decode_BRANCH_CTRL_2_87 = 4'b0000;
  assign _zz__zz_decode_BRANCH_CTRL_2_88 = (_zz__zz_decode_BRANCH_CTRL_2_89 != 1'b0);
  assign _zz__zz_decode_BRANCH_CTRL_2_91 = (_zz__zz_decode_BRANCH_CTRL_2_92 != _zz__zz_decode_BRANCH_CTRL_2_96);
  assign _zz__zz_decode_BRANCH_CTRL_2_97 = {_zz__zz_decode_BRANCH_CTRL_2_98,_zz__zz_decode_BRANCH_CTRL_2_101};
  assign _zz__zz_decode_BRANCH_CTRL_2_56 = 32'h00001010;
  assign _zz__zz_decode_BRANCH_CTRL_2_58 = (decode_INSTRUCTION & 32'h00002010);
  assign _zz__zz_decode_BRANCH_CTRL_2_59 = 32'h00002010;
  assign _zz__zz_decode_BRANCH_CTRL_2_61 = ((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_62) == 32'h00000010);
  ...
  assign _zz__zz_decode_BRANCH_CTRL_2_72 = 32'h00000070;
  assign _zz__zz_decode_BRANCH_CTRL_2_76 = (decode_INSTRUCTION & 32'h00000020);
  assign _zz__zz_decode_BRANCH_CTRL_2_77 = 32'h0;
  ...
  assign _zz__zz_decode_BRANCH_CTRL_2_85 = {_zz_decode_BRANCH_CTRL_4,_zz__zz_decode_BRANCH_CTRL_2_86};
  assign _zz__zz_decode_BRANCH_CTRL_2_89 = ((decode_INSTRUCTION & _zz__zz_decode_BRANCH_CTRL_2_90) == 32'h0);
  assign _zz__zz_decode_BRANCH_CTRL_2_92 = {_zz__zz_decode_BRANCH_CTRL_2_93,{_zz__zz_decode_BRANCH_CTRL_2_94,_zz__zz_decode_BRANCH_CTRL_2_95}};
  assign _zz__zz_decode_BRANCH_CTRL_2_96 = 3'b000;
  assign _zz__zz_decode_BRANCH_CTRL_2_98 = ({_zz__zz_decode_BRANCH_CTRL_2_99,_zz__zz_decode_BRANCH_CTRL_2_100} != 2'b00);
  assign _zz__zz_decode_BRANCH_CTRL_2_101 = ({_zz__zz_decode_BRANCH_CTRL_2_102,_zz__zz_decode_BRANCH_CTRL_2_103} != 2'b00);
  assign _zz__zz_decode_BRANCH_CTRL_2_62 = 32'h00000050;
  assign _zz__zz_decode_BRANCH_CTRL_2_64 = (decode_INSTRUCTION & 32'h0000000c);
  assign _zz__zz_decode_BRANCH_CTRL_2_65 = 32'h00000004;
  assign _zz__zz_decode_BRANCH_CTRL_2_67 = (decode_INSTRUCTION & 32'h00000028);
  assign _zz__zz_decode_BRANCH_CTRL_2_68 = 32'h0;
  assign _zz__zz_decode_BRANCH_CTRL_2_81 = 32'h00000044;
  assign _zz__zz_decode_BRANCH_CTRL_2_83 = (decode_INSTRUCTION & 32'h00000018);
  assign _zz__zz_decode_BRANCH_CTRL_2_84 = 32'h0;
  assign _zz__zz_decode_BRANCH_CTRL_2_86 = ((decode_INSTRUCTION & 32'h00005004) == 32'h00001000);
  assign _zz__zz_decode_BRANCH_CTRL_2_90 = 32'h00000058;
  assign _zz__zz_decode_BRANCH_CTRL_2_93 = ((decode_INSTRUCTION & 32'h00000044) == 32'h00000040);
  assign _zz__zz_decode_BRANCH_CTRL_2_94 = ((decode_INSTRUCTION & 32'h00002014) == 32'h00002010);
  assign _zz__zz_decode_BRANCH_CTRL_2_95 = ((decode_INSTRUCTION & 32'h40000034) == 32'h40000030);
  assign _zz__zz_decode_BRANCH_CTRL_2_99 = ((decode_INSTRUCTION & 32'h00000014) == 32'h00000004);
  assign _zz__zz_decode_BRANCH_CTRL_2_100 = _zz_decode_BRANCH_CTRL_3;
  assign _zz__zz_decode_BRANCH_CTRL_2_102 = ((decode_INSTRUCTION & 32'h00000044) == 32'h00000004);
  assign _zz__zz_decode_BRANCH_CTRL_2_103 = _zz_decode_BRANCH_CTRL_3;
  always @(posedge io_mainClk) begin
  ...
  always @(*) begin
    case(_zz_decode_BRANCH_CTRL_7)
      `BranchCtrlEnum_binary_sequential_INC : _zz_decode_BRANCH_CTRL_7_string = "INC ";
      `BranchCtrlEnum_binary_sequential_B : _zz_decode_BRANCH_CTRL_7_string = "B   ";
      `BranchCtrlEnum_binary_sequential_JAL : _zz_decode_BRANCH_CTRL_7_string = "JAL ";
      `BranchCtrlEnum_binary_sequential_JALR : _zz_decode_BRANCH_CTRL_7_string = "JALR";
  ...
  assign _zz_decode_BRANCH_CTRL_7 = _zz_decode_BRANCH_CTRL_2[24 : 23];
...
module IceFunLedCtrl (
  input      [31:0]   io_data_in,
  input      [15:0]   io_divider,
  output reg [7:0]    io_leds,
  output     [3:0]    io_ledCols,
  input               io_mainClk,
  input               resetCtrl_systemReset
);
  ...
  wire                when_iceFunLedCtrl_l70;
  wire                when_iceFunLedCtrl_l80;
  wire                when_iceFunLedCtrl_l91;
  wire                when_iceFunLedCtrl_l101;
  `ifndef SYNTHESIS
  ...
  always @(*) begin
    case(fsm_stateReg)
      ...
      `fsm_enumDefinition_binary_sequential_fsm_col0 : fsm_stateReg_string = "fsm_col0";
      `fsm_enumDefinition_binary_sequential_fsm_col1 : fsm_stateReg_string = "fsm_col1";
      `fsm_enumDefinition_binary_sequential_fsm_col2 : fsm_stateReg_string = "fsm_col2";
      `fsm_enumDefinition_binary_sequential_fsm_col3 : fsm_stateReg_string = "fsm_col3";
  ...
  always @(*) begin
    case(fsm_stateNext)
      ...
      `fsm_enumDefinition_binary_sequential_fsm_col0 : fsm_stateNext_string = "fsm_col0";
      `fsm_enumDefinition_binary_sequential_fsm_col1 : fsm_stateNext_string = "fsm_col1";
      `fsm_enumDefinition_binary_sequential_fsm_col2 : fsm_stateNext_string = "fsm_col2";
      `fsm_enumDefinition_binary_sequential_fsm_col3 : fsm_stateNext_string = "fsm_col3";
  ...
  always @(*) begin
    ...
    case(fsm_stateReg)
      ...
      `fsm_enumDefinition_binary_sequential_fsm_col0 : begin
      end
      `fsm_enumDefinition_binary_sequential_fsm_col1 : begin
      end
      `fsm_enumDefinition_binary_sequential_fsm_col2 : begin
      end
      `fsm_enumDefinition_binary_sequential_fsm_col3 : begin
      end
      default : begin
        fsm_wantStart = 1'b1;
      end
  ...
  always @(*) begin
    ...
    case(fsm_stateReg)
      `fsm_enumDefinition_binary_sequential_fsm_init : begin
        fsm_stateNext = `fsm_enumDefinition_binary_sequential_fsm_col0;
      end
      `fsm_enumDefinition_binary_sequential_fsm_col0 : begin
        if(when_iceFunLedCtrl_l70) begin
          fsm_stateNext = `fsm_enumDefinition_binary_sequential_fsm_col1;
        end
      end
      `fsm_enumDefinition_binary_sequential_fsm_col1 : begin
        if(when_iceFunLedCtrl_l80) begin
          fsm_stateNext = `fsm_enumDefinition_binary_sequential_fsm_col2;
        end
      end
      `fsm_enumDefinition_binary_sequential_fsm_col2 : begin
        if(when_iceFunLedCtrl_l91) begin
          fsm_stateNext = `fsm_enumDefinition_binary_sequential_fsm_col3;
        end
      end
      `fsm_enumDefinition_binary_sequential_fsm_col3 : begin
        if(when_iceFunLedCtrl_l101) begin
          fsm_stateNext = `fsm_enumDefinition_binary_sequential_fsm_col0;
        end
      end
      default : begin
  ...
  assign when_iceFunLedCtrl_l70 = (counter == io_divider);
  assign when_iceFunLedCtrl_l80 = (counter == io_divider);
  assign when_iceFunLedCtrl_l91 = (counter == io_divider);
  assign when_iceFunLedCtrl_l101 = (counter == io_divider);
  always @(posedge io_mainClk or posedge resetCtrl_systemReset) begin
    if(resetCtrl_systemReset) begin
      counter <= 16'h0;
      leds <= 8'h0;
      ...
      case(fsm_stateReg)
        ...
        `fsm_enumDefinition_binary_sequential_fsm_col0 : begin
          ...
          leds[1] <= io_data_in[4];
          leds[2] <= io_data_in[8];
          leds[3] <= io_data_in[12];
          leds[4] <= io_data_in[16];
          leds[5] <= io_data_in[20];
          leds[6] <= io_data_in[24];
          leds[7] <= io_data_in[28];
        ...
        `fsm_enumDefinition_binary_sequential_fsm_col1 : begin
          ...
          leds[1] <= io_data_in[5];
          leds[2] <= io_data_in[9];
          leds[3] <= io_data_in[13];
          leds[4] <= io_data_in[17];
          leds[5] <= io_data_in[21];
          leds[6] <= io_data_in[25];
          leds[7] <= io_data_in[29];
          counter <= (counter + 16'h0001);
          if(when_iceFunLedCtrl_l80) begin
            counter <= 16'h0;
          end
        ...
        `fsm_enumDefinition_binary_sequential_fsm_col2 : begin
          ...
          leds[0] <= io_data_in[2];
          leds[1] <= io_data_in[6];
          leds[2] <= io_data_in[10];
          leds[3] <= io_data_in[14];
          leds[4] <= io_data_in[18];
          leds[5] <= io_data_in[22];
          leds[6] <= io_data_in[26];
          leds[7] <= io_data_in[30];
          counter <= (counter + 16'h0001);
          if(when_iceFunLedCtrl_l91) begin
            counter <= 16'h0;
          end
        ...
        `fsm_enumDefinition_binary_sequential_fsm_col3 : begin
          ...
          leds[0] <= io_data_in[3];
          leds[1] <= io_data_in[7];
          leds[2] <= io_data_in[11];
          leds[3] <= io_data_in[15];
          leds[4] <= io_data_in[19];
          leds[5] <= io_data_in[23];
          leds[6] <= io_data_in[27];
          leds[7] <= io_data_in[31];
          counter <= (counter + 16'h0001);
          if(when_iceFunLedCtrl_l101) begin
            counter <= 16'h0;
          end
