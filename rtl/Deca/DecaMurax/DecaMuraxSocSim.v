...
module DecaMuraxSocSim (
  ...
  wire       [0:0]    _zz_io_i2c_0_scl_1;
  wire       [0:0]    _zz_io_i2c_0_sda_1;
  reg                 _zz_io_gpioA;
  reg                 _zz_io_gpioA_1;
  reg                 _zz_io_gpioA_2;
  reg                 _zz_io_gpioA_3;
  ...
  reg                 _zz_io_gpioA_14;
  reg                 _zz_io_gpioA_15;
  reg                 _zz_io_i2c_0_sda;
  reg                 _zz_io_i2c_0_scl;
  ...
  assign _zz_io_i2c_0_scl_1 = 1'b0;
  assign _zz_io_i2c_0_sda_1 = 1'b0;
  MainDecaMuraxSoc murax (
    .io_asyncReset           (murax_io_asyncReset         ), //i
    ...
    .io_spi_0_miso           (io_spi_0_miso               ), //i
    .io_leds                 (murax_io_leds               )  //o
  );
  assign io_i2c_0_scl = _zz_io_i2c_0_scl ? _zz_io_i2c_0_scl_1[0] : 1'bz;
  assign io_i2c_0_sda = _zz_io_i2c_0_sda ? _zz_io_i2c_0_sda_1[0] : 1'bz;
  ...
  always @(*) begin
    _zz_io_i2c_0_sda = 1'b0;
    if(when_InOutWrapper_l48_1) begin
      _zz_io_i2c_0_sda = 1'b1;
    end
  end

  always @(*) begin
    _zz_io_i2c_0_scl = 1'b0;
    if(when_InOutWrapper_l48) begin
      _zz_io_i2c_0_scl = 1'b1;
    end
  end

  assign murax_io_asyncReset = (! io_mainReset);
  ...
  assign io_uart_0_txd = murax_io_uart_0_txd;
  ...
  assign io_spi_0_ss = murax_io_spi_0_ss;
  assign io_spi_0_sclk = murax_io_spi_0_sclk;
  assign io_spi_0_mosi = murax_io_spi_0_mosi;
  assign _zz_io_i2c_0_scl_read = io_i2c_0_scl;
  assign when_InOutWrapper_l48 = (! _zz_when_InOutWrapper_l48_2[0]);
  assign _zz_io_i2c_0_sda_read = io_i2c_0_sda;
...
module PipelinedMemoryBusRam (
  ...
  initial begin
    $readmemb("DecaMuraxSocSim.v_toplevel_murax_system_ram_ram_symbol0.bin",ram_symbol0);
    $readmemb("DecaMuraxSocSim.v_toplevel_murax_system_ram_ram_symbol1.bin",ram_symbol1);
    $readmemb("DecaMuraxSocSim.v_toplevel_murax_system_ram_ram_symbol2.bin",ram_symbol2);
    $readmemb("DecaMuraxSocSim.v_toplevel_murax_system_ram_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
