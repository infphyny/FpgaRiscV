...
LD_SCRIPT := $(FUSESOC_CORE_DIR)sw/ColorLight/Briey/src/riscv.ld
CRT0_OBJ := $(FUSESOC_CORE_DIR)sw/ColorLight/Briey/src/crt0.o


SOC_INCLUDE_DIRECTORY := -I $(FUSESOC_CORE_DIR)sw/ColorLight/Briey/include
...
BRAM_NAME_BASE := ColorLightBriey.v_toplevel_axi_ram_ram_symbol
