...
set_location_assignment PIN_M8 -to mainClk
set_instance_assignment -name IO_STANDARD "2.5 V" -to mainClk
...
set_location_assignment PIN_H21 -to mainReset
set_instance_assignment -name IO_STANDARD "1.5 V" -to mainReset
...
set_location_assignment PIN_AB19 -to gpioA[8]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[8]
set_location_assignment PIN_Y16 -to gpioA[9]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[9]
set_location_assignment PIN_V16 -to gpioA[10]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[10]
set_location_assignment PIN_AB18 -to gpioA[11]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[11]
set_location_assignment PIN_V15 -to gpioA[12]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[12]
set_location_assignment PIN_W17 -to gpioA[13]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[13]
set_location_assignment PIN_AB17 -to gpioA[14]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[14]
set_location_assignment PIN_AA16 -to gpioA[15]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to gpioA[15]
...
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to GPIO0_D[39]
 ...
 set_location_assignment PIN_W14 -to jtag_tdi
 set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to jtag_tdi

 set_location_assignment PIN_U15 -to jtag_tdo
 set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to jtag_tdo

 set_location_assignment PIN_R13 -to jtag_tms
...
#P9
# UART_0
set_location_assignment PIN_Y5 -to uart_0_rxd
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to uart_0_rxd

set_location_assignment PIN_Y6 -to uart_0_txd
...
set_location_assignment PIN_V7 -to spi_0_ss
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to spi_0_ss
